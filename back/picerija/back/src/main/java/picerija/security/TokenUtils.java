...
/*
 * Klasa koja pruza osnovne funkcionalnosti rada sa tokenom*/
@Component
public class TokenUtils {

	@Value("myXAuthSecret")
	private String secret;	// tajna koja nam treba za generisanje postpisa tokena

	@Value("631152000")
	//@Value("1")
	private Long expiration;	// period vazenja tokena izrazen u sekundama
